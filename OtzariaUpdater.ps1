...
$form.Add_Resize({
    if ($form.WindowState -ne "Minimized") {
        ...
        # Keep header buttons on the left side (RTL)
        $btnRefresh.Location = New-Object System.Drawing.Point(($formWidth - 100), 10)
        $btnTheme.Location = New-Object System.Drawing.Point(($formWidth - 52), 10)
    }
})
