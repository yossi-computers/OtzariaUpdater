...
$script:OldStableRelease = $null  # For fallback when user doesn't want beta
...
# Show custom beta warning dialog with 3 buttons
function Show-BetaWarningDialog {
    param(
        [string]$OldVersion,
        [string]$NewVersion
    )
    ...
    # Create custom dialog form - matching main form style
    $dlgForm = New-Object System.Windows.Forms.Form
    $dlgForm.Text = "אזהרת גרסת בטא"
    $dlgForm.Size = New-Object System.Drawing.Size(620, 220)
    $dlgForm.StartPosition = "CenterScreen"
    $dlgForm.FormBorderStyle = "FixedDialog"
    $dlgForm.MaximizeBox = $false
    $dlgForm.MinimizeBox = $false
    $dlgForm.RightToLeft = "Yes"
    $dlgForm.RightToLeftLayout = $true
    $dlgForm.TopMost = $true
    $dlgForm.Font = New-Object System.Drawing.Font("Segoe UI", 10)
    $dlgForm.BackColor = $t.CardColor
    $dlgForm.ForeColor = $t.TextColor
    
    # Warning icon on the right side (RTL)
    ...
    $dlgForm.Controls.Add($iconBox)
    
    # Message label with static text including "ראה" (same line as link)
    $msgLabel = New-Object System.Windows.Forms.Label
    $msgLabel.Location = New-Object System.Drawing.Point(85, 35)
    $msgLabel.Size = New-Object System.Drawing.Size(435, 25)
    $msgLabel.Text = "שים לב: גירסה זו דורשת תשומת לב מיוחדת, ראה"
    $msgLabel.Font = New-Object System.Drawing.Font("Segoe UI", 10)
    $msgLabel.ForeColor = $t.TextColor
    $msgLabel.TextAlign = "MiddleLeft"
    $msgLabel.AutoSize = $false
    $dlgForm.Controls.Add($msgLabel)
    
    # LinkLabel for "כאן" - on same line after the message
    $linkLabel = New-Object System.Windows.Forms.LinkLabel
    $linkLabel.Location = New-Object System.Drawing.Point(520, 35)
    $linkLabel.Size = New-Object System.Drawing.Size(40, 25)
    $linkLabel.Text = "כאן"
    $linkLabel.Font = New-Object System.Drawing.Font("Segoe UI", 10, [System.Drawing.FontStyle]::Underline)
    $linkLabel.LinkColor = $t.ProgBar
    $linkLabel.ActiveLinkColor = $t.ProgBar
    $linkLabel.VisitedLinkColor = $t.ProgBar
    $linkLabel.TextAlign = "MiddleLeft"
    $linkLabel.Add_LinkClicked({
        Start-Process "https://forum.otzaria.org/post/93"
    })
    $dlgForm.Controls.Add($linkLabel)
    
    # Question label
    $questionLabel = New-Object System.Windows.Forms.Label
    $questionLabel.Location = New-Object System.Drawing.Point(20, 80)
    $questionLabel.Size = New-Object System.Drawing.Size(570, 30)
    $questionLabel.Text = "האם ברצונך להוריד את הגרסה הישנה - $($OldVersion)?"
    $questionLabel.Font = New-Object System.Drawing.Font("Segoe UI", 10, [System.Drawing.FontStyle]::Bold)
    $questionLabel.ForeColor = $t.TextColor
    $questionLabel.TextAlign = "MiddleLeft"
    $dlgForm.Controls.Add($questionLabel)
    
    # Result variable
    $script:BetaDialogResult = "Cancel"
    
    # Button panel at bottom - RTL order: Yes on right, Cancel on left
    $btnYes = New-Object System.Windows.Forms.Button
    $btnYes.Location = New-Object System.Drawing.Point(20, 125)
    $btnYes.Size = New-Object System.Drawing.Size(130, 38)
    $btnYes.Text = "כן"
    $btnYes.Font = New-Object System.Drawing.Font("Segoe UI", 10)
    $btnYes.BackColor = $t.BtnBg
    $btnYes.ForeColor = $t.TextColor
    $btnYes.FlatStyle = "Flat"
    $btnYes.FlatAppearance.BorderColor = $t.BtnBorder
    $btnYes.Cursor = [System.Windows.Forms.Cursors]::Hand
    $btnYes.Add_Click({
        $script:BetaDialogResult = "DownloadOld"
        $dlgForm.Close()
    })
    $dlgForm.Controls.Add($btnYes)
    
    # Continue anyway button - middle
    $btnContinue = New-Object System.Windows.Forms.Button
    $btnContinue.Location = New-Object System.Drawing.Point(210, 125)
    $btnContinue.Size = New-Object System.Drawing.Size(170, 38)
    $btnContinue.Text = "המשך בכל זאת"
    $btnContinue.Font = New-Object System.Drawing.Font("Segoe UI", 10)
    $btnContinue.BackColor = $t.BtnBg
    $btnContinue.ForeColor = $t.TextColor
    $btnContinue.FlatStyle = "Flat"
    $btnContinue.FlatAppearance.BorderColor = $t.BtnBorder
    $btnContinue.Cursor = [System.Windows.Forms.Cursors]::Hand
    $btnContinue.Add_Click({
        $script:BetaDialogResult = "ContinueBeta"
        $dlgForm.Close()
    })
    $dlgForm.Controls.Add($btnContinue)
    
    # Cancel button - left side
    $btnCancelDlg = New-Object System.Windows.Forms.Button
    $btnCancelDlg.Location = New-Object System.Drawing.Point(460, 125)
    $btnCancelDlg.Size = New-Object System.Drawing.Size(130, 38)
    $btnCancelDlg.Text = "ביטול"
    $btnCancelDlg.Font = New-Object System.Drawing.Font("Segoe UI", 10)
    $btnCancelDlg.BackColor = $t.BtnBg
    $btnCancelDlg.ForeColor = $t.TextColor
    $btnCancelDlg.FlatStyle = "Flat"
    $btnCancelDlg.FlatAppearance.BorderColor = $t.BtnBorder
    $btnCancelDlg.Cursor = [System.Windows.Forms.Cursors]::Hand
    $btnCancelDlg.Add_Click({
        $script:BetaDialogResult = "Cancel"
        $dlgForm.Close()
    })
    $dlgForm.Controls.Add($btnCancelDlg)
    
    $dlgForm.AcceptButton = $btnYes
    $dlgForm.CancelButton = $btnCancelDlg
    
    [void]$dlgForm.ShowDialog()
    
    return $script:BetaDialogResult
}
...
# Get the old stable release (0.9.74) for fallback when user doesn't want beta
function Get-OldStableRelease {
    # Display version and saved filename is 0.9.74.513, but download URL uses otzaria-0.9.74-windows.exe
    $displayVersion = "0.9.74.513"
    $savedFileName = "otzaria-0.9.74.513-windows.exe"  # The name we save locally
    $url = "https://github.com/Otzaria/otzaria/releases/download/0.9.74%2B513/otzaria-0.9.74-windows.exe"
...
$btnFixLibrary = New-Object System.Windows.Forms.Button
$btnFixLibrary.Text = "תיקון ספריה"
$btnFixLibrary.Size = New-Object System.Drawing.Size(150,40)
$btnFixLibrary.Location = New-Object System.Drawing.Point(15,685)
$btnFixLibrary.FlatStyle = "Flat"
$btnFixLibrary.Font = New-Object System.Drawing.Font("Segoe UI Semibold",11)
$toolTip.SetToolTip($btnFixLibrary, "תיקון המניפסט - הסרת רשומות של קבצים שלא קיימים")
...
$form.Controls.AddRange(@($header,$mainCard,$libCard,$btnFixLibrary,$btnClearCache,$btnVCRedist,$statusDivider,$statusLocation,$statusBar,$lblNetwork))
...
function Apply-Theme {
    ...
    foreach ($btn in @($btnDL, $btnCancel, $btnPreChangelog, $btnLibDL, $btnLibCancel, $btnLibChangelog, $btnLibExtract, $btnLibSelectFile, $btnClearCache, $btnVCRedist, $btnTheme, $btnRefresh, $btnSelectFile, $btnLibUpdate, $btnFixLibrary)) {
...
$form.Add_Shown({
    ...
    # Position bottom buttons - all 3 buttons always visible
    # Total width = 150 (fix) + 10 (gap) + 250 (cache) + 10 (gap) + 180 (VC) = 600
    # Form width is 700, so startX = (700 - 600) / 2 = 50
    $totalWidth = $btnFixLibrary.Width + 10 + $btnClearCache.Width + 10 + $btnVCRedist.Width
    $startX = [int]((700 - $totalWidth) / 2)
    $btnVCRedist.Location = New-Object System.Drawing.Point($startX, 685)
    $btnClearCache.Location = New-Object System.Drawing.Point(($startX + $btnVCRedist.Width + 10), 685)
    $btnFixLibrary.Location = New-Object System.Drawing.Point(($startX + $btnVCRedist.Width + 10 + $btnClearCache.Width + 10), 685)
...
$form.Add_Resize({
    if ($form.WindowState -ne "Minimized") {
        ...
        # Center bottom buttons - all 3 buttons
        $totalWidth = $btnFixLibrary.Width + 10 + $btnClearCache.Width + 10 + $btnVCRedist.Width
        $startX = [int](($formWidth - $totalWidth) / 2)
        $btnVCRedist.Location = New-Object System.Drawing.Point($startX, $btnVCRedist.Location.Y)
        $btnClearCache.Location = New-Object System.Drawing.Point(($startX + $btnVCRedist.Width + 10), $btnClearCache.Location.Y)
        $btnFixLibrary.Location = New-Object System.Drawing.Point(($startX + $btnVCRedist.Width + 10 + $btnClearCache.Width + 10), $btnFixLibrary.Location.Y)
...
$btnLibUpdate.Add_Click({
    ...
    $script:DiffUpdateJob = Start-Job -ScriptBlock {
        ...
        # Function to clean file names from characters not supported in CP862
        # This prevents question marks when adding files to ZIP
        function CleanFileName($name) {
            if ([string]::IsNullOrEmpty($name)) { return $name }
            
            # Remove Unicode directional markers using character codes
            # LRM (U+200E), RLM (U+200F), LRE (U+202A), RLE (U+202B), PDF (U+202C), LRO (U+202D), RLO (U+202E)
            # LRI (U+2066), RLI (U+2067), FSI (U+2068), PDI (U+2069)
            $name = $name -replace [char]0x200E, ''
            $name = $name -replace [char]0x200F, ''
            $name = $name -replace [char]0x202A, ''
            $name = $name -replace [char]0x202B, ''
            $name = $name -replace [char]0x202C, ''
            $name = $name -replace [char]0x202D, ''
            $name = $name -replace [char]0x202E, ''
            $name = $name -replace [char]0x2066, ''
            $name = $name -replace [char]0x2067, ''
            $name = $name -replace [char]0x2068, ''
            $name = $name -replace [char]0x2069, ''
            
            # Replace Hebrew maqaf (־ U+05BE) with space
            $name = $name -replace [char]0x05BE, ' '
            
            # Replace Hebrew gershayim (״ U+05F4) with two apostrophes ('')
            $name = $name -replace [char]0x05F4, "''"
            
            # Hebrew geresh (׳ U+05F3) stays as regular apostrophe (')
            $name = $name -replace [char]0x05F3, "'"
            
            # Remove Hebrew diacritics/vowels/cantillation marks (nikud and teamim U+0591-U+05C7)
            $name = $name -replace '[\u0591-\u05C7]', ''
            
            # Clean up any double spaces or leading/trailing spaces in path segments
            $name = ($name -split '[/\\]' | ForEach-Object { $_.Trim() -replace '  +', ' ' } | Where-Object { $_ -ne '' }) -join '/'
        ...
        function ConvertPath($manifestPath) {
            ...
            if ($manifestPath -match '^.*/ספרים/אוצריא/(.+)$') {
                $result = "אוצריא/$($matches[1])"
            }
            # Special case: DictaToOtzaria/ערוך/ספרים/אוצריא/... -> אוצריא/...
            elseif ($manifestPath -match '^.*/ערוך/ספרים/אוצריא/(.+)$') {
                $result = "אוצריא/$($matches[1])"
            }
            # Links files: */links/... -> links/...
            elseif ($manifestPath -match '^.*/links/(.+)$') {
                $result = "links/$($matches[1])"
            }
            
            # Clean the result from problematic characters
            if ($result) {
        ...
        try {
            ...
            # Write log so far
            if ($logFile) { $logContent | Out-File $logFile -Encoding UTF8 }
            
            $total = $filteredDownloads.Count + $filteredDeletes.Count + 1  # +1 for manifest update
            $current = 0
            $encoding = [System.Text.Encoding]::GetEncoding(862)
            
            # === CLEANUP STEP: Rename all entries with nikud or question marks to clean names ===
            $logContent += ""
            $logContent += "========================================="
            $logContent += "=== CLEANUP: Renaming entries with problematic chars ==="
            $logContent += "========================================="
            
            try {
                # First, read entries with Read mode to properly detect question marks and nikud
                $zipArchiveRead = [System.IO.Compression.ZipFile]::Open($zipPath, 'Read', $encoding)
                $entriesToRename = @()
                $debugCount = 0
                
                foreach ($entry in $zipArchiveRead.Entries) {
                    $originalName = $entry.FullName
                    $cleanName = $originalName
                    
                    # Remove nikud
                    $cleanName = $cleanName -replace '[\u0591-\u05C7]', ''
                    # Remove directional markers
                    $cleanName = $cleanName -replace [char]0x200E, ''
                    $cleanName = $cleanName -replace [char]0x200F, ''
                    $cleanName = $cleanName -replace [char]0x202A, ''
                    $cleanName = $cleanName -replace [char]0x202B, ''
                    $cleanName = $cleanName -replace [char]0x202C, ''
                    # Replace Hebrew punctuation
                    $cleanName = $cleanName -replace [char]0x05BE, ' '
                    $cleanName = $cleanName -replace [char]0x05F4, "''"
                    $cleanName = $cleanName -replace [char]0x05F3, "'"
                    # Remove question marks using regex
                    $cleanName = $cleanName -replace '\?', ''
                    # Remove any char between 128-1423 (non-Hebrew high bytes)
                    $cleanChars = @()
                    foreach ($char in $cleanName.ToCharArray()) {
                        $code = [int]$char
                        if ($code -le 127 -or $code -ge 1424) {
                            $cleanChars += $char
                        }
                    }
                    $cleanName = -join $cleanChars
                    
                    # Clean spaces but preserve path structure
                    if ($cleanName -match '[/\\]') {
                        $cleanName = ($cleanName -split '[/\\]' | ForEach-Object { $_.Trim() -replace '  +', ' ' } | Where-Object { $_ -ne '' }) -join '/'
                        if ($originalName.EndsWith('/') -and -not $cleanName.EndsWith('/')) {
                            $cleanName += '/'
                        }
                    }
                    
                    # Use length comparison as well because PowerShell -eq ignores some Unicode control chars
                    if ((($cleanName -ne $originalName) -or ($cleanName.Length -ne $originalName.Length)) -and -not [string]::IsNullOrEmpty($cleanName)) {
                        $entriesToRename += @{
                            Original = $originalName
                            Clean = $cleanName
                            IsDirectory = $originalName.EndsWith('/')
                        }
                    }
                }
                
                $logContent += "Found $($entriesToRename.Count) entries to rename"
                $logContent += "  - With nikud: $(($entriesToRename | Where-Object { $_.Original -match '[\u0591-\u05C7]' }).Count)"
                $logContent += "  - With question marks: $(($entriesToRename | Where-Object { $_.Original -match '\?' }).Count)"
                $zipArchiveRead.Dispose()
                $zipArchiveRead = $null
                
                # Rename entries (need to handle encoding differences between Read and Update modes)
                if ($entriesToRename.Count -gt 0) {
                    $renamedCount = 0
                    
                    # Open in Update mode and build a map of clean->actual names
                    $zipArchive = [System.IO.Compression.ZipFile]::Open($zipPath, 'Update', $encoding)
                    
                    foreach ($item in $entriesToRename) {
                        try {
                            # Find the entry - it might have a different representation in Update mode
                            # We'll search by base name (without problematic chars)
                            $targetClean = $item.Clean
                            
                            # Try exact match first
                            $existingEntry = $zipArchive.Entries | Where-Object { $_.FullName -eq $item.Original } | Select-Object -First 1
                            
                            # If not found, try matching by cleaned name
                            if (-not $existingEntry) {
                                # Clean each entry name the same way and compare
                                foreach ($entry in $zipArchive.Entries) {
                                    $entryName = $entry.FullName
                                    $entryCleaned = $entryName
                                    # Apply same cleaning rules
                                    $entryCleaned = $entryCleaned -replace '[\u0591-\u05C7]', ''
                                    $entryCleaned = $entryCleaned -replace [char]0x200E, ''
                                    $entryCleaned = $entryCleaned -replace [char]0x200F, ''
                                    $entryCleaned = $entryCleaned -replace [char]0x202A, ''
                                    $entryCleaned = $entryCleaned -replace [char]0x202B, ''
                                    $entryCleaned = $entryCleaned -replace [char]0x202C, ''
                                    $entryCleaned = $entryCleaned -replace [char]0x05BE, ''
                                    $entryCleaned = $entryCleaned -replace [char]0x05F4, "''"
                                    $entryCleaned = $entryCleaned -replace [char]0x05F3, "'"
                                    $entryCleaned = $entryCleaned -replace '\?', ''
                                    # Remove high bytes
                                    $cleanChars2 = @()
                                    foreach ($char in $entryCleaned.ToCharArray()) {
                                        $code = [int]$char
                                        if ($code -le 127 -or $code -ge 1424) {
                                            $cleanChars2 += $char
                                        }
                                    }
                                    $entryCleaned = -join $cleanChars2
                                    # Clean spaces
                                    if ($entryCleaned -match '[/\\]') {
                                        $entryCleaned = ($entryCleaned -split '[/\\]' | ForEach-Object { $_.Trim() -replace '  +', ' ' } | Where-Object { $_ -ne '' }) -join '/'
                                        if ($entryName.EndsWith('/') -and -not $entryCleaned.EndsWith('/')) {
                                            $entryCleaned += '/'
                                        }
                                    }
                                    
                                    if ($entryCleaned -eq $targetClean) {
                                        $existingEntry = $entry
                                        break
                                    }
                                }
                            ...
                            if ($existingEntry) {
                                if ($item.IsDirectory) {
                                    # For directories, just create new and delete old
                                    $newDirEntry = $zipArchive.CreateEntry($item.Clean)
                                    $newDirEntry.Open().Close()
                                    $existingEntry.Delete()
                                } else {
                                    # For files, extract content, create new entry, delete old
                                    $stream = $existingEntry.Open()
                                    ...
                                    $newEntry = $zipArchive.CreateEntry($item.Clean, [System.IO.Compression.CompressionLevel]::Optimal)
                                ...
                                if ($renamedCount -le 20) {
                                    $logContent += "RENAMED: [$($existingEntry.FullName)] -> [$($item.Clean)]"
                                }
                            }
                        } catch {
                            $logContent += "ERROR renaming [$($item.Original)]: $($_.Exception.Message)"
                        }
                    }
                    
                    $zipArchive.Dispose()
                    $logContent += "Total renamed: $renamedCount"
                }
            } catch {
                $logContent += "ERROR in cleanup step: $($_.Exception.Message)"
                # Make sure to dispose the ZIP if it's still open
                if ($zipArchive) {
            ...
            # === DEBUG: List all entries BEFORE update ===
            $logContent += ""
            $logContent += "========================================="
            $logContent += "=== DEBUG: ZIP ENTRIES BEFORE UPDATE ==="
            $logContent += "========================================="
            try {
                $debugZip = [System.IO.Compression.ZipFile]::Open($zipPath, 'Read', $encoding)
                $entryCount = 0
                foreach ($entry in $debugZip.Entries) {
                    $entryCount++
                    $rawName = $entry.FullName
                    $hasNikud = $rawName -match '[\u0591-\u05C7]'
                    $hasQuestionMark = $rawName -match '\?'
                    $flags = ""
                    if ($hasNikud) { $flags += "[NIKUD]" }
                    if ($hasQuestionMark) { $flags += "[HAS ?]" }
                    
                    # Only log entries with issues or first 50
                    if ($hasNikud -or $hasQuestionMark -or $entryCount -le 50) {
                        $logContent += "BEFORE[$entryCount]: $rawName $flags"
                    }
                }
                $logContent += "Total entries before: $entryCount"
                $debugZip.Dispose()
            } catch {
                $logContent += "ERROR reading ZIP before update: $($_.Exception.Message)"
            }
            if ($logFile) { $logContent | Out-File $logFile -Encoding UTF8 }
            
            # Add debug section header
            $logContent += ""
            $logContent += "=== DEBUG: Path conversions ==="
            ...
            foreach ($manifestFile in $filteredDownloads) {
                ...
                # Debug log - show path before and after cleaning
                $debugLine = "DEBUG: [$manifestFile] -> [$zipEntryPath]"
                $logContent += $debugLine
                ...
                try {
                    ...
                    # Remove existing entry if exists - check both clean and original paths
                    ...
                    if ($existingEntry) {
                        $logContent += "  -> Found exact match, deleting: $($existingEntry.FullName)"
                        $existingEntry.Delete()
                    }
                    
                    # Also check for entries with nikud that would match after cleaning
                    # This handles cases where the ZIP has entries with nikud but we want clean names
                    $entriesToDelete = @()
                    foreach ($entry in $zipArchive.Entries) {
                        $cleanedEntryName = $entry.FullName
                        # Remove nikud
                        $cleanedEntryName = $cleanedEntryName -replace '[\u0591-\u05C7]', ''
                        # Remove directional markers
                        $cleanedEntryName = $cleanedEntryName -replace [char]0x200E, ''
                        $cleanedEntryName = $cleanedEntryName -replace [char]0x200F, ''
                        $cleanedEntryName = $cleanedEntryName -replace [char]0x202A, ''
                        $cleanedEntryName = $cleanedEntryName -replace [char]0x202B, ''
                        $cleanedEntryName = $cleanedEntryName -replace [char]0x202C, ''
                        # Replace Hebrew punctuation
                        $cleanedEntryName = $cleanedEntryName -replace [char]0x05BE, ' '
                        $cleanedEntryName = $cleanedEntryName -replace [char]0x05F4, "''"
                        $cleanedEntryName = $cleanedEntryName -replace [char]0x05F3, "'"
                        # Clean spaces
                        $cleanedEntryName = ($cleanedEntryName -split '[/\\]' | ForEach-Object { $_.Trim() -replace '  +', ' ' } | Where-Object { $_ -ne '' }) -join '/'
                        
                        if ($cleanedEntryName -eq $zipEntryPath -and $entry.FullName -ne $zipEntryPath) {
                            $entriesToDelete += $entry
                            $logContent += "  -> Found nikud match: [$($entry.FullName)] cleaned to [$cleanedEntryName]"
                        }
                    }
                    foreach ($entry in $entriesToDelete) {
                        $logContent += "  -> Deleting nikud entry: $($entry.FullName)"
                        try { $entry.Delete() } catch { $logContent += "  -> ERROR deleting: $($_.Exception.Message)" }
                    }
                    ...
                    $logContent += "  -> Creating new entry: $zipEntryPath"
            ...
            # Write final log with all debug info
            $logContent += ""
            $logContent += "========================================="
            $logContent += "=== DEBUG: ZIP ENTRIES AFTER UPDATE ==="
            $logContent += "========================================="
            try {
                $debugZip = [System.IO.Compression.ZipFile]::Open($zipPath, 'Read', $encoding)
                $entryCount = 0
                ...
                foreach ($entry in $debugZip.Entries) {
                    ...
                    $hasQuestionMark = $rawName -match '\?'
                    $flags = ""
                    if ($hasNikud) { $flags += "[NIKUD]"; $entriesWithIssues++ }
                    if ($hasQuestionMark) { $flags += "[HAS ?]"; $entriesWithIssues++ }
                    
                    # Only log entries with issues or first 50
                    if ($hasNikud -or $hasQuestionMark -or $entryCount -le 50) {
                        $logContent += "AFTER[$entryCount]: $rawName $flags"
                    }
                }
                $logContent += "Total entries after: $entryCount"
                $logContent += "Entries with issues (nikud or ?): $entriesWithIssues"
                $debugZip.Dispose()
            } catch {
                $logContent += "ERROR reading ZIP after update: $($_.Exception.Message)"
            }
            
            $logContent += ""
            $logContent += "=== Update completed ==="
            if ($logFile) { $logContent | Out-File $logFile -Encoding UTF8 }
...
$btnRefresh.Add_Click({
    ...
    if ($hasNetwork) {
        ...
        if ($existingLibZip) {
            ...
            # Library file exists - show server version and check if update available
            $script:LibDownloadCompleted = $true
            $script:LibFileToExtract = $existingLibZip.Name
            ...
            $localVerNum = 0
            $serverVerNum = 0
            if ($zipVer -match '^\d+$') { $localVerNum = [int]$zipVer }
            if ($script:LibVer -match '^\d+$') { $serverVerNum = [int]$script:LibVer }
            
            if ($serverVerNum -gt $localVerNum) {
                # Update available - show both update and extract buttons
                $lblLibV.Text = "גרסה בארכיון: $zipVer   |   גרסה בשרת: $($script:LibVer)"
                ...
                $libStatusLbl.Visible = $true
                $libStatusLbl.Text = "קובץ ספרייה גרסה $zipVer קיים - עדכון זמין לגרסה $($script:LibVer)"
            } else {
                # Local version is same or newer - show only extract button
                $lblLibV.Text = "גרסה בשרת: $($script:LibVer)"
...
$btnDL.Add_Click({
    ...
    if ($script:InstallType -eq "MSIX") {
        ...
        elseif ($radioPre.Checked) { 
            $script:SelectedRelease = $script:PreMsixRelease
            $isBetaSelected = $true
        }
    } else {
    ...
    # Show beta warning dialog if beta is selected (EXE mode only)
    if ($isBetaSelected -and $script:InstallType -eq "EXE") {
        # Get old stable version info
        $script:OldStableRelease = Get-OldStableRelease
        $oldVersion = $script:OldStableRelease.FullVersion
        $newVersion = $script:SelectedRelease.FullVersion
        
        # Show custom dialog
        $dialogResult = Show-BetaWarningDialog -OldVersion $oldVersion -NewVersion $newVersion
        
        if ($dialogResult -eq "Cancel") {
            $statusLbl.Text = "ההורדה בוטלה"
            return
        }
        elseif ($dialogResult -eq "DownloadOld") {
            # User wants to download the old stable version
            $script:SelectedRelease = $script:OldStableRelease
            $statusLbl.Text = "מוריד גרסה יציבה ישנה: $oldVersion"
        }
        # If "ContinueBeta" - continue with the selected beta release
    }
...
$btnLibExtract.Add_Click({
    ...
    if ($extractMode -eq "update") {
        # Update extraction - compare files using manifest hash values
        $libStatusLbl.Text = "טוען מניפסטים להשוואה..."
        [System.Windows.Forms.Application]::DoEvents()
        ...
        try {
            ...
            # Read manifests for hash comparison
            $zipManifest = @{}
            $localManifest = @{}
            
            # Read ZIP manifest (files_manifest.json from archive)
            $manifestEntry = $archive.Entries | Where-Object { $_.Name -eq "files_manifest.json" } | Select-Object -First 1
            if ($manifestEntry) {
                $stream = $manifestEntry.Open()
                $reader = New-Object System.IO.StreamReader($stream, [System.Text.Encoding]::UTF8)
                ...
                $reader.Close()
                $stream.Close()
                $zipManifest = $manifestJson | ConvertFrom-Json
            }
            
            # Read local manifest
            $localManifestPath = Join-Path $p "files_manifest.json"
            if (Test-Path $localManifestPath) {
                $localManifestJson = Get-Content $localManifestPath -Raw -Encoding UTF8
                $localManifest = $localManifestJson | ConvertFrom-Json
            }
            
            # Convert manifest paths to ZIP paths (remove prefix and map to actual ZIP structure)
            # Manifest uses: "sefariaToOtzaria/sefaria_export/ספרים/אוצריא/..." or "MoreBooks/ספרים/אוצריא/..."
            # ZIP uses: "אוצריא/..."
            function Convert-ManifestPathToZipPath {
                param([string]$manifestPath)
                # Remove the prefix to get the actual path in ZIP
                $prefixes = @(
                    "sefariaToOtzaria/sefaria_export/ספרים/",
            ...
            # Build hash lookup from ZIP manifest
            $zipHashes = @{}
            if ($zipManifest) {
                $zipManifest.PSObject.Properties | ForEach-Object {
                    $zipEntryPath = Convert-ManifestPathToZipPath $_.Name
                    $zipHashes[$zipEntryPath] = $_.Value.hash
                }
            }
            
            # Build hash lookup from local manifest  
            $localHashes = @{}
            if ($localManifest) {
                $localManifest.PSObject.Properties | ForEach-Object {
                    $localPath = Convert-ManifestPathToZipPath $_.Name
                    $localHashes[$localPath] = $_.Value.hash
                }
            }
            
            # Build list of all files in ZIP
            $zipFiles = @{}
            ...
            $manifestPathLocal = Join-Path $p "files_manifest.json"
            if (Test-Path $manifestPathLocal) {
                $localFiles["files_manifest.json"] = @{ FullPath = $manifestPathLocal }
            }
            
            $metadataPath = Join-Path $p "metadata.json"
            if (Test-Path $metadataPath) {
                $localFiles["metadata.json"] = @{ FullPath = $metadataPath }
            }
            
            $libStatusLbl.Text = "משווה קבצים לפי hash..."
            [System.Windows.Forms.Application]::DoEvents()
            
            # Find files to extract (new or different hash)
            $filesToExtract = @()
            foreach ($zipEntryPath in $zipFiles.Keys) {
                if (-not $localFiles.ContainsKey($zipEntryPath)) {
                    # File doesn't exist locally - add it
                    $filesToExtract += $zipEntryPath
                } else {
                    # Compare by hash from manifests
                    $zipHash = $zipHashes[$zipEntryPath]
                    $localHash = $localHashes[$zipEntryPath]
                    
                    if ($zipHash -and $localHash) {
                        if ($zipHash -ne $localHash) {
                            # Hash is different - file was modified
                            $filesToExtract += $zipEntryPath
                        }
                    } elseif ($zipHash -and -not $localHash) {
                        # File exists but not in local manifest - extract it
                        $filesToExtract += $zipEntryPath
                    } else {
                        # No hash in manifest - compare by file size
                        $zipEntry = $zipFiles[$zipEntryPath].Entry
                        $localFilePath = $localFiles[$zipEntryPath].FullPath
                        if ($zipEntry -and (Test-Path $localFilePath)) {
                            $localSize = (Get-Item $localFilePath).Length
                            if ($zipEntry.Length -ne $localSize) {
                                $filesToExtract += $zipEntryPath
                            }
                        } else {
                            # Can't compare - extract to be safe
                            $filesToExtract += $zipEntryPath
                        }
                    }
                }
            ...
            # Always extract manifest and metadata files
            if ($zipFiles.ContainsKey("files_manifest.json") -and $filesToExtract -notcontains "files_manifest.json") {
                $filesToExtract += "files_manifest.json"
            }
            if ($zipFiles.ContainsKey("metadata.json") -and $filesToExtract -notcontains "metadata.json") {
                $filesToExtract += "metadata.json"
            }
    ...
    try {
        ...
        # Use CP862 (DOS Hebrew) - verified as correct encoding for Otzaria library
        $encoding = [System.Text.Encoding]::GetEncoding(862)
        $archive = [System.IO.Compression.ZipFile]::Open($zipPath, 'Read', $encoding)
        $errorLog += "Using encoding: CP862 (DOS Hebrew)"
        ...
        foreach ($entry in $archive.Entries) {
            ...
            try {
                ...
                # Clean entry name from nikud and special characters that cause issues
                # Remove Hebrew diacritics/vowels/cantillation marks (nikud and teamim U+0591-U+05C7)
                $cleanEntryName = $entryName -replace '[\u0591-\u05C7]', ''
                # Remove Unicode directional markers
                $cleanEntryName = $cleanEntryName -replace [char]0x200E, ''
                $cleanEntryName = $cleanEntryName -replace [char]0x200F, ''
                $cleanEntryName = $cleanEntryName -replace [char]0x202A, ''
                $cleanEntryName = $cleanEntryName -replace [char]0x202B, ''
                $cleanEntryName = $cleanEntryName -replace [char]0x202C, ''
                $cleanEntryName = $cleanEntryName -replace [char]0x202D, ''
                $cleanEntryName = $cleanEntryName -replace [char]0x202E, ''
                # Replace Hebrew maqaf with regular hyphen
                $cleanEntryName = $cleanEntryName -replace [char]0x05BE, '-'
                # Replace Hebrew gershayim with double apostrophe
                $cleanEntryName = $cleanEntryName -replace [char]0x05F4, "''"
                # Replace Hebrew geresh with apostrophe
                $cleanEntryName = $cleanEntryName -replace [char]0x05F3, "'"
                # Replace question marks that result from encoding issues
                $cleanEntryName = $cleanEntryName -replace '\?+', ''
                # Clean up double spaces
                $cleanEntryName = $cleanEntryName -replace '  +', ' '
                
                $targetPath = Join-Path $p $cleanEntryName
                
                # Skip if it's a directory entry (ends with /)
                if ($cleanEntryName.EndsWith("/") -or $cleanEntryName.EndsWith("\")) {
...
# Fix Library Button - removes manifest entries for files that don't exist
$btnFixLibrary.Add_Click({
    $rootPath = $script:InstallPath
    
    if (-not $rootPath -or -not (Test-Path $rootPath)) {
        Show-RTLMessageBox "לא נמצאה תיקיית אוצריא" "שגיאה" "OK" "Error"
        return
    }
    
    $manifestPath = Join-Path $rootPath "files_manifest.json"
    
    if (-not (Test-Path -LiteralPath $manifestPath)) {
        Show-RTLMessageBox "קובץ המניפסט לא נמצא!" "שגיאה" "OK" "Error"
        return
    }
    
    $r = Show-RTLMessageBox "פעולה זו תסרוק את הספרייה ותסיר מהמניפסט רשומות של קבצים שלא קיימים.`n`nהאם להמשיך?" "תיקון ספריה" "YesNo" "Question"
    if ($r -ne "Yes") {
        return
    }
    
    $libStatusLbl.Visible = $true
    $libStatusLbl.Text = "סורק קבצים..."
    [System.Windows.Forms.Application]::DoEvents()
    ...
    try {
        ...
        $libStatusLbl.Text = "אוסף רשימת קבצים..."
        [System.Windows.Forms.Application]::DoEvents()
        ...
        $libStatusLbl.Text = "נמצאו $($keysToRemove.Count) רשומות להסרה מתוך $totalEntries"
        [System.Windows.Forms.Application]::DoEvents()
        ...
        if ($keysToRemove.Count -gt 0) {
            ...
            $libStatusLbl.Text = "הספרייה תוקנה"
            Show-RTLMessageBox "הספרייה תוקנה בהצלחה!`n`nהוסרו $($keysToRemove.Count) רשומות מהמניפסט." "תיקון ספריה" "OK" "Information"
        } else {
            $libStatusLbl.Text = "הספרייה תקינה"
            Show-RTLMessageBox "הספרייה תקינה - לא נדרשו שינויים." "תיקון ספריה" "OK" "Information"
        }
        
    } catch {
        $libStatusLbl.Text = "שגיאה בתיקון"
        Show-RTLMessageBox "שגיאה בתיקון הספרייה: $($_.Exception.Message)" "שגיאה" "OK" "Error"
    }
})
