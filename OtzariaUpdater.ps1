...
function Get-OldStableRelease {
    # Display version and saved filename is 0.9.74.482, but download URL uses otzaria-0.9.74-windows.exe
    $displayVersion = "0.9.74.482"
    $savedFileName = "otzaria-0.9.74.482-windows.exe"  # The name we save locally
    $url = "https://github.com/Otzaria/otzaria/releases/download/0.9.74%2B482/otzaria-0.9.74-windows.exe"
